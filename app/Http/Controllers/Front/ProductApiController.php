...
class ProductApiController extends Controller
{
     ...
     * Returns the NEXT product: pid=0 -> product 1, pid=1 -> product 2, pid=2 -> product 3, etc.
     */
    public function getProductData($pid)
    {
        ...
        // Convert pid to integer: pid=0 -> next=1, pid=1 -> next=2, etc.
        $pid = (int)$pid;
        $nextProductId = $pid + 1;
        
        // Get next product by ID (status=1 active products)
        $product = Product::whe√re('status', 1)
