          ...
          <div class="sidebar-block">
            <div class="sidebar-box listing-box mb-40"> <span class="opener plus"></span>
              ...
              <div class="sidebar-contant">
                <ul>
                    @foreach($cate as $v)
                    <li><a href="/{{$v->slug ?? $v->name}}">{{$v->name}}<span></span></a></li>
                    @endforeach
                </ul>
              </div>
            </div>
            ...
            <div class="sidebar-box sidebar-item"> <span class="opener plus"></span>
              ...
              <div class="sidebar-contant">
                ...
                @foreach($best as $aproduct)
                  <li>
                    <div class="pro-media"> <a href="/{{$aproduct->slug}}"><img alt="T-shirt" src="{{asset($aproduct->image_one)}}"></a> </div>
              ...
              @endphp
                ...
                <div class="col-md-4 col-xs-6 mb-30">
                  ...
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="/{{$aproduct->slug}}"> <img src="{{asset($aproduct->image_one)}}" alt="{{$aproduct->product_name}}"> </a>
                    ...
                    <div class="product-item-details">
                      <div class="product-item-name"> <a href="/{{$aproduct->slug}}">{{$aproduct->product_name}}</a> </div>
