            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <a href="/{{$v->slug}}"> <img class="img-fluid w-100" width="281px" height="281px" src="{{asset($v->image_one)}}" alt="{{$v->product_name}}"> </a>
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3"><a href="/{{$v->slug}}">{{$v->product_name}}</a></h6>
                        <div class="d-flex justify-content-center">
                            <h6>Rs {{$v->discount_price}}</h6><h6 class="text-muted ml-2"><del>Rs {{$v->selling_price}}</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="/{{$v->slug}}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
