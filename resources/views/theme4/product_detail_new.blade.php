    ...
    <div class="container">
        <div class="inside-content-indicator">
            <ul>
                ...
                @if($cate)
                <li><a href="{{ url('/'.$cate->slug) }}">{{ $cate->name }}</a></li>
                @endif
                @if($sub_cat)
            ...
            <div class="single-page-product-details">
                ...
                <div class="rating-media-single-page">
                    ...
                    <div class="single-page-media">
                        <ul>
                            <li><a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url('/'.$item->slug)) }}" target="_blank"><img src="{{ $assets_url }}images/facebook-icon.svg"></a></li>
                            <li><a href="https://twitter.com/intent/tweet?url={{ urlencode(url('/'.$item->slug)) }}&text={{ urlencode($item->product_name) }}" target="_blank"><img src="{{ $assets_url }}images/twitter-icon-large.svg"></a></li>
                            <li><a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(url('/'.$item->slug)) }}" target="_blank"><img src="{{ $assets_url }}images/linkedin-icon-01.svg"></a></li>
                            <li><a href="https://pinterest.com/pin/create/button/?url={{ urlencode(url('/'.$item->slug)) }}&media={{ urlencode(env('IMG_URL').$item->image_one) }}&description={{ urlencode($item->product_name) }}" target="_blank"><img src="{{ $assets_url }}images/pinterest-icon-large.svg"></a></li>
                            <li><a href="https://api.whatsapp.com/send?text={{ urlencode($item->product_name . ' - ' . url('/'.$item->slug)) }}" target="_blank"><img src="{{ $assets_url }}images/whatsapp-icon-large.svg"></a></li> 
                       </ul>
                ...
                <div class="products-section">
                    ...
                    <div class="single-product-section product">
                        ...
                        <div class="product-detail-section">
                            <h3><a href="{{ url('/'.$v->slug) }}">{{$v->product_name}}</a></h3>
