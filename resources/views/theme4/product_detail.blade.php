...
<div class="whatsapp-float-btn">
    <a href="https://wa.me/{{ $setting->whatsapp }}?text=Hello! I'm interested in {{ urlencode($item->product_name) }} - {{ urlencode(url('/'.$item->slug)) }}" target="_blank" class="whatsapp-btn-link">
