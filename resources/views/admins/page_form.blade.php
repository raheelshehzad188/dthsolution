                ...
                <div class="ibox-content">
                    <form action="{{ url('/') }}/admin/page_form" id="page_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><label class="col-sm-12 control-label">Page Route:</label>
                            ...
                            <span>Fill once you want to add page which defind in laravel routes, Like category menu, Product menu<br>For example {{url('/')}}/your-category-slug — put here only the path segment, e.g. <b>your-category-slug</b></span>
                        </div>
