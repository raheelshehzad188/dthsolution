        ...
        <div class="ibox float-e-margins">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$page->menu}}</td>
                    <td>
                        <a href="{{ (Route::has('admins.page_form') ? route('admins.page_form',$page->id) : url('/admin/page_form/'.$page->id)) }}?section=1" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp;Edit</a>
