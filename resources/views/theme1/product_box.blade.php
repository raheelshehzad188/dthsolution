...
?><div class="card-product style-skincare">
                                                <div class="card-product-wrapper">
                                                    <a href="{{url('/')}}/{{$v->slug}}" class="product-img">
                                ...
                                <a href="{{url('/')}}/{{$v->slug}}" data-bs-toggle="modal" class="box-icon bg_white quickview tf-btn-loading">
                            ...
                            <a href="{{url('/')}}/{{$v->slug}}">
                                                ...
                                                <div class="card-product-info text-center">
                                                    <a href="{{url('/')}}/{{$v->slug}}" class="title link">{{$v->product_name}}</a>
